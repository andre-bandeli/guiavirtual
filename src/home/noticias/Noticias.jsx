  ...
  return (
    <div className='noticiasHome'>
        ...
        <div className="containerNoticiasHome">
            ...
            <div class="news-item">
                <div className="text">
                    <Link to="https://www.youtube.com/watch?v=ZdpZ-93uUnY" target='_blank'>Música P.U.T.A. Composição de Mulamba</Link>
                </div>
            </div>
            <div class="news-item">
                <div className="text">
                    <Link to="https://www.fcm.unicamp.br/imprensa/" target='_blank'>Conheça mais sobre a Pesquisa acessando o site da FCM</Link>
                </div>
            </div>
            <div class="news-item">
                <div className="text">
                    <Link to="https://catarinas.info/cuidado-reaja-e-busque-ajuda-conheca-os-sinais-de-alerta-no-machistometro/" target='_blank'>Machistômetro</Link>
                </div>
            </div>
